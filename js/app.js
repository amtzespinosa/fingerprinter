...
function fingerprint_ip() {
    fetch('https://ipapi.co/json/')
        ...
        .then(function(data) {
            var locSep = ", "
            document.getElementById('ip').innerHTML = data.version + ": " + data.ip;
            document.getElementById('location').innerHTML = "Location: " + data.city + locSep + data.region + locSep + data.country_name;
            document.getElementById('isp').innerHTML = "ISP: " + data.org;
            document.getElementById('network').innerHTML = "Network: " + data.network;
            document.getElementById('timezone').innerHTML = "UTC" + data.utc_offset;
        });
